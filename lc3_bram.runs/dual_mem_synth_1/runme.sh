...
HD_PWD='D:/lc3_bram/lc3_bram.runs/dual_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dual_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dual_mem.tcl
